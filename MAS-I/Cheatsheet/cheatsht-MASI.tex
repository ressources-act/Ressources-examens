...
\og \textit{Path vectors} \fg{} ayant le minimum de composantes pour fonctionner. Donc, le système cesse de fonctionner dès qu'une des composantes qui fonctionne échoue. \\
