...
Mallow's $C_{p}$
\lfbox[formula]{$C_{p} = \frac{SSE + 2p \times MSE_{g}}{n}$}

AIC
\lfbox[formula]{$AIC = \frac{SSE + 2p \times MSE_{g}}{n \times MSE_{g}}$}

BIC
\lfbox[formula]{$BIC = \frac{SSE + \ln(n) \times p \times MSE_{g}}{n \times MSE_{g}}$}
