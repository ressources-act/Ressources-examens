...
Le coefficient de détermination \lfbox[formula]{$R^{2} = \frac{SSR}{SST} = 1 -  \frac{SSE}{SST}$}.
\end{definitionNOHFILL}
...
Puisque \lfbox[conditions]{$\Pi_{g} = \sum_{c = 1}^{g} = 1$} nous avons encore seulement $g - 1$ probabilités à estimer.
