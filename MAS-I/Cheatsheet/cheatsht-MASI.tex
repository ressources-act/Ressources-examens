...
\columnbreak
\subsubsection{Identifier le test le plus puissant}
...
On souhaite identifier le test le plus puissance pour un seuil fixé $\alpha$.
...
\columnbreak
\subsubsection{Identifier le test le plus puissance avec des hypothèses composées}
...
La région uniformément la plus puissante n'existe pas toujours, mais dans le cas qu'elle existe le théorème de Neyman-Pearson permet de la trouver.
...
%%%	Théorème de factorisation de Fisher-Neyman (cas de plus d'un paramètre)
