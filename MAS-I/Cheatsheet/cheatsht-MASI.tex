...
\begin{definitionNOHFILL}[Coefficient de corrélation $R^{2}$]
\begin{rappel_enhanced}[Contexte]
Le $R^{2}$ est une mesure de corrélation qui correspond au carré du coefficient de corrélation : \lfbox[formula]{$R^{2} = r_{Y, x}^{2}$}. Le $R^{2}$ est plus facilement interprétable que le coefficient de corrélation de Pearson, particulièrement pour la régression linéaire.
...
La statistique \lfbox[formula]{$R^{2} = \frac{SSR}{SST} = 1 -  \frac{SSE}{SST}$}.
\end{definitionNOHFILL}
