...
On applique la même procédure en posant un $\theta$ fixe pour l'hypothèse alternative dans le ratio. Il s'ensuit que pour toute valeur de $\theta$ qui y est supérieur, la relation va demeurer.\\

Le test n'existe pas toujours, mais dans le cas qu'il existe le théorème de Neymann-Pearson permet de le trouver.
