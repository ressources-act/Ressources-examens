...
\end{align*}
Cependant, puisque nous utilisons une distribution continue (normale) pour approximer une distribution discrète (Poisson), il faut appliquer une correction de continuité.
\end{definitionNOHFILLprop}
