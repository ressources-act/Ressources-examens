...
Thus, PV sensitivity = $\frac{-P'(i)}{P(i)}$. This is actually the \textbf{modified duration} and deriving by the \textit{force of interest} leads to the Macaulary Duration $\frac{-P'(\delta)}{P(\delta)}$.
