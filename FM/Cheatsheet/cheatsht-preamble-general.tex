...
%% Encoding packages
%% -----------------------------
\usepackage{booktabs} % special rules
...
%% Variable definition
%% -----------------------------
\def\auteur{\href{https://github.com/ressources-act/Guide_de_survie_en_actuariat/blob/master/02_Cheatsheets/contributeurs-cheatshts.pdf}{\faGithub \ Liste des contributeurs}}
