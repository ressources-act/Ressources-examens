...
\newcommand{\calc}[1]{\colorbox{arsenic}{\textcolor{white}{#1}}}
...
\DeclareTColorBox{knowledge}{ o }			% #1 parameter
{
	enhanced,
	title = #1,
	colback=asparagus, % color of the box
%	colframe=blue(pigment),
%	colframe=asparagus,	
	breakable,
	colbacktitle=ao(english),
	fonttitle = \bfseries,
	boxed title style={size=small,colframe=arsenic} ,
	attach boxed title to top center = {yshift=-3mm,yshifttext=-1mm},
%	left=0pt,
...
\definecolor{amaranth}{rgb}{0.9, 0.17, 0.31}			%	bloom 
\definecolor{babyblue}{rgb}{0.54, 0.81, 0.94} 		%	bloom 
\definecolor{amber}{rgb}{1.0, 0.75, 0.0}				%	bloom 
