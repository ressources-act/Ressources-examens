...
\begin{align*}
	...
	&=	\Pr\left(\frac{R_{0, T}	-	\text{E}[R_{0, T}]}{\text{Var}(R_{0, T})}	\leq		\frac{\ln\left(\frac{K}{S_{0}}\right)	-	\text{E}[R_{0, T}]}{\text{Var}(R_{0, T})} \right)	\\
	&=	\Pr\left(\textcolor{teal}{Z}	\leq		\frac{\ln\left(\frac{K}{S_{0}}\right)	-	\text{E}[R_{0, T}]}{\text{Var}(R_{0, T})} \right)	\\
	&=	\Pr\left(Z	\leq		\frac{\ln\left(\frac{K}{S_{0}}\right)	-	\left(\alpha - \delta - \frac{1}{2}\sigma^{2}\right)T}{\sigma^{2}T} \right)	\\
	&=	N(-\hat{d}_{2})
\end{align*}
\end{algo}
