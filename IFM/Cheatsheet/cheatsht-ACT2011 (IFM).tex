...
\begin{enumerate}
	\item	Les investisseurs peuvent transiger tous les titres aux prix compétitifs du marché.
		\begin{itemize}
...
Donc, en effectuant la moyenne pondérée des rendements on trouve que \lfbox[formula]{$r_{d}	=	y	-	pL$}.
\end{definitionNOHFILLsub}
