...
\begin{definitionNOHFILLpropos}[1.	Les coûts d'une détresse financière et de faillite]
\begin{itemize}
...
\begin{definitionNOHFILLpropos}[2.	La probabilité d'une détresse financière et d'une faillite]
\begin{itemize}
...
\begin{definitionNOHFILLpropos}[3.	Le taux d'actualisation des coûts de détresse financière]
\begin{itemize}
...
\begin{enumerate}
	\item	Émettre de la dette à court-terme.
		\begin{itemize}
		\item	Ceci réduit la chance qu'une entreprise prenne des décisions non-optimales contre allant à l'encontre des intérêts des créanciers.
		\item	Cependant, ceci peut augmenter le risque	de détresse financière.
		\end{itemize}
	\item	Inclure des \og \textit{debt covenants} \fg{} dans les obligations qui limitent les actions que peut prendre l'entreprise.
		\begin{itemize}
		\item	P. ex., restreindre l'habilitée de l'entreprise de verser des grosses dividendes, limiter les investissements qu'elle peut faire, etc.
