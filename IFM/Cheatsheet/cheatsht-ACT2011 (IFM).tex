...
\begin{definitionNOHFILL}[Ligne d'allocation du capital]
%%	------------------------
%%%	NOTES
%%%	+	Clarifier cette définition.
%%%	------------------------
La ligne d'allocation du capital (AC) décrit les rendements espérés et volatilités possibles des différentes combinaisons d'un portefeuille risqué et d'un actif sans risque :
\begin{center}
\tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt        
...
\begin{itemize}
	...
	\item	La pente de la ligne d'AC représente le rendement additionnel disponible par incrément d'une unité de risque et équivaut au \textit{\textbf{ratio de Sharpe}}.
\end{itemize}
\end{definitionNOHFILL}
...
\begin{itemize}
	...
	\item	Visuellement, ceci équivaut au pointillé de la ligne d'AC ;
...
Avec la ligne de l'AC et la frontière efficiente, on peut trouver le \textbf{portefeuille risqué optimal} $P$ :
\begin{center}
\tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt        
...
\columnbreak
\subsubsection{Ligne du marché des capitaux}
\begin{rappel_enhanced}[Contexte]
Si chaque investisseur a des attentes de rendement espéré, volatilité et corrélation différentes, alors chaque investisseur aura une ligne d'AC et un portefeuille risqué optimal différent.\\
...
L'hypothèse que les attentes des investisseurs sont homogènes implique également une même ligne d'AC et un même portefeuille optimal pour le marché.

\begin{definitionNOHFILL}[Portefeuille du marché]
Portefeuille optimal du marché.
\begin{itemize}
...
\begin{definitionNOHFILL}[Ligne du marché des capitaux]
Ligne d'AC du marché.
...
\begin{center}
{\footnotesize \textcolor[rgb]{0.56,0.07,1}{ligne du marché }}\\{\footnotesize \textcolor[rgb]{0.56,0.07,1}{des capitaux}}
\end{center}
...
\columnbreak
\subsubsection{The Capital Asset Pricing Model (CAPM)}


\columnbreak
\subsubsection{Market Risk Premium}


\columnbreak
\subsubsection{The Debt Cost of Capital}


\columnbreak
\subsubsection{Required Return on All-Equity Project}


\columnbreak
\subsubsection{Required Return on a Leveraged Project}
...
%\pagebreak
%\section{Investment Risk and Project Analysis}
