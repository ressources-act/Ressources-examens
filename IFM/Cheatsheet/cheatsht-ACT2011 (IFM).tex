...
Le MÉDAF multi-factorial prend plusieurs facteurs en considération pour estimer le rendement espéré. Ce modèle muti-factorial est aussi connu comme la théorie de l'arbitrage de prix (\og \textit{arbitrage pricing theory (APT)} \fg{}).
\end{rappel_enhanced}
\begin{distributions}[Notation]
\begin{description}
...
\begin{enumerate}
	\item	Un modèle multi-factorial décrit les rendements d'un actif sans toutefois indiquer le nombre de facteurs.
