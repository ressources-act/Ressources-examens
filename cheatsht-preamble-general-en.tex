...
% Author : Gabriel Crépeault-Cauchon and Alec James van Rassel

% Note : This preamble creates documents intended to be used within the multicols environment.
...
%
\fancyhead{} 	% Reset
\fancyhead[L]{Study aid for~\cours ~(\textbf{\sigle})}
\fancyhead[R]{\auteur}
